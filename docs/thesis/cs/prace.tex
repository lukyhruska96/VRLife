...
\def\NazevPrace{3D sociální síť}

% Název práce v angličtině
\def\NazevPraceEN{3D social network}

% Jméno autora
\def\AutorPrace{Lukáš Hruška}
...
\def\KlicovaSlova{%
{Sociální síť} {3D} {Unity}
}
\def\KlicovaSlovaEN{%
{Social Network} {3D} {Unity}
}
